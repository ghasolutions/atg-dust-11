...
public class GSARepositorySchemaGenerator {
  ...
  Logger mLogger = Logger.getLogger(GSARepositorySchemaGenerator.class);
   ...
   */
  public GSARepositorySchemaGenerator(GSARepository pRepository,boolean pIncludeExistingTables) throws RepositoryException {
   ...
   * @throws RepositoryException
   */
  public GSARepositorySchemaGenerator(GSARepository pRepository) throws RepositoryException {
  ...
  public void buildModel(GSARepository pRepository, boolean pIncludeExistingTables) throws RepositoryException {
    ...
    mDatabaseTypeNameToJDBC = new DatabaseTypeNameToJDBC(pRepository.getDatabaseTableInfo());
    mRepository = pRepository;
    mPlatform = PlatformFactory.createNewPlatformInstance(pRepository.getDataSource());
  ...
  public void createSchema(final boolean pContinueOnError, final boolean pDrop)
    ...
    boolean success = new DoInAutoCommit(this, mRepository).doInAutoCommit(new AutoCommitable() {
          
          public void doInAutoCommit(Connection pConnection) {
            mPlatform.createTables(pConnection, mDatabase, pDrop, pContinueOnError);
          }
        });
    if (!success)
   ...
   * @throws DatabaseOperationException
   */
  public void dropSchema(final boolean pContinueOnError) throws DatabaseOperationException, SQLException {
	  
	mLogger.debug("dropSchema(): Begin");
   ...
   * @throws DatabaseOperationException
   */
  public void alterSchema(final boolean pContinueOnError) throws DatabaseOperationException, SQLException {
	  
    mPlatform.alterTables(mRepository.getConnection(), mDatabase, pContinueOnError);
