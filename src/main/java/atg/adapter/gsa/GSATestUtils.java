...
//        newRepository.copyFromOtherRepository(pRepository);
  ...
  /**
   * <p>Simplest configuration path initialization we provide.  Disables screen logging to allow for
   * smaller test logs.  Use one of the other initialization methods if you desire the additional
   * logging.
   * 
   * @param pRoot
  ...
  public  void initializeMinimalConfigpath(File pRoot,
                                           ...
                                           String[] pImportFile) throws IOException, Exception {

     initializeMinimalConfigpath(pRoot, 
    		                     pRepositoryPath, 
    		                     pDefinitionFiles, 
    		                     pJDBCProperties, 
    		                     null, 
  ...
  public  void initializeMinimalConfigpath(File pRoot,
                                           ...
                                           String pDropSQLAbsolutePath, 
                                           String[] pImportFile, 
                                           boolean pLogging) throws IOException, Exception {
  ...
  public  void initializeMinimalConfigpath(File pRoot,
	...
	mLogger.debug("initializeMinimalConfigPath() root=" + pRoot.getAbsolutePath() + " repository=" + pRepositoryPath);  
	  
    if (pRepositoryPath != null) {
    	createRepositoryPropertiesFile(pRoot, 
    			                       pRepositoryPath, 
    			                       pDefinitionFiles, 
  ...
  public  File createIdSpaces(File pRoot) throws IOException {
    ...
    File idspacesFile = new File(pRoot.getAbsolutePath() + "/atg/dynamo/service/idspaces.xml");
    
	mLogger.debug("createIdSpaces file: " + idspacesFile.getAbsolutePath());
...
//---------------------------
  public  static File createFakeXADataSource(File pRoot,
    ...
    pJDBCProperties.put("transactionManager", "/atg/dynamo/transaction/TransactionManager");
    
    return NucleusTestUtils.createProperties(name, 
    		                                 new File(pRoot.getAbsolutePath() + "/atg/dynamo/service/jdbc"), 
    		                                 "atg.service.jdbc.FakeXADataSource",
                                             pJDBCProperties);
  }
  ...
  public  File createScreenLog(File pRoot, boolean pLogging) throws IOException {
    ...
    return NucleusTestUtils.createProperties("ScreenLog", 
    		                                 new File(pRoot.getAbsolutePath() + "/atg/dynamo/service/logging"), 
  ...
  public  File createGlobal(File pRoot) throws IOException {
    ...
    return NucleusTestUtils.createProperties("GLOBAL", 
    		                                 new File(pRoot.getAbsolutePath() + "/"), 
    		                                 null, 
    		                                 prop);
  ...
  public  File createRepositoryPropertiesFile(File pRoot,
    ...
    // create a properties file to apply to our repository definition
    Properties props = new Properties();
    ...
    for (int i = 0; i < pDefinitionFiles.length; i++) {
      ...
      if (obj != null) {
        ...
        throw new AssertionError("Repository definition file " + pDefinitionFiles[i] + 
        		                 "  not found in classpath or configpath: " + pRoot);
      }
 ...
 //   String index = null;
  ...
  public  void assertEmptyRepository(DBUtils dbTwo, GSARepository storeRepository) throws Exception, SQLException {
    ...
    for (int i = 0 ; i < namesAfter.length; i++) {
      mLogger.info(namesAfter[i] + ":" + dbTwo.getRowCount(namesAfter[i]));
  ...
  public  void createIDGeneratorTables(DBUtils db) throws SQLException {
    try {
      ...
      // drop and try again
      mLogger.debug("DROPPING DAS_ID_GENERATOR");
